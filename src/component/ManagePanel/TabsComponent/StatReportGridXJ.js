...
this.setState({ selectedRowKeys });
  ...
  render() {
    ...
    <div>
      ...
      <Table rowKey="STID" columns={this.state.columns}  loading={this.state.loading} dataSource={this.state.data} rowSelection={rowSelection}
...
class StatSearch extends Component {
  render() {
    const { getFieldProps } = this.props.form;
       ...
       const cityform=getFieldProps('citys',{});
       const startDateform=getFieldProps('startDate',{});
       const endDateform=getFieldProps('endDate',{});
   const menu = (
    ...
    <Form layout="inline"  >
       ...
       <Col span={4} >
        <FormItem {...formItemLayout} label="城市"> 
            <Select {...cityform} placeholder="选择地市" style={{ width: 120 }} onChange={this.city} allowClear={true}>
        ...
        <Col span={4}>
         <FormItem {...formItemLayout} label="开始时间" >
               ...
               <DatePicker {...startDateform} placeholder="开始时间"/>
         ...
         <Col span={4} >
          <FormItem {...formItemLayout} label="结束时间">
                ...
                <DatePicker {...endDateform}  placeholder="结束时间" />
